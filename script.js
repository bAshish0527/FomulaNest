...
const FORMULAS = {
    ...
    10: {
        ...
        chemistry: [
            ...
            ['Chemical Reaction definition', 'Process that leads to the chemical transformation of one set of chemical substances to another'],
            ['Balanced Equation', 'An equation with equal number of atoms of each element on reactants and products side'],
            ['Oxidation definition', 'The gain of oxygen or loss of electrons during a reaction'],
            ['Reduction definition', 'The loss of oxygen or gain of electrons during a reaction'],
            ['', ''],
            ['Acids, Bases and Salts', ''],
            ['pH Value Formula', 'pH = −log[H⁺] (where [H⁺] is hydrogen ion concentration)'],
            ['Neutralization Reaction', 'Acid + Base → Salt + Water'],
            ['Example Neutralization', 'HCl + NaOH → NaCl + H₂O'],
            ['Acid definition', 'A substance that produces hydrogen (H⁺) ions in aqueous solution'],
            ['Base definition', 'A substance that produces hydroxide (OH⁻) ions in aqueous solution'],
            ['pH Scale definition', 'A scale ranging from 0 to 14 used to measure the acidity or basicity of a solution'],
            ['Salt definition', 'An ionic compound formed by the neutralization reaction between an acid and a base'],
            ['', ''],
            ['Metals and Non-metals', ''],
            ['Metal Oxide Reaction', 'Metal + Oxygen → Metal Oxide'],
            ['Metal Acid Reaction', 'Metal + Acid → Salt + H₂ (hydrogen gas)'],
            ['Example Reaction', 'Zn + 2HCl → ZnCl₂ + H₂'],
            ['Metal definition', 'An element that is typically lustrous, malleable, ductile, and a good conductor of heat and electricity'],
            ['Non-metal definition', 'An element that is a poor conductor of heat and electricity and lacks metallic properties'],
            ['Corrosion definition', 'The slow destruction of metals by the action of air, moisture, or chemicals on their surface'],
            ['Reactivity Series', 'Arrangement of metals in decreasing order of their reactivity'],
            ['', ''],
            ['Carbon and its Compounds', ''],
            ['Alkane General Formula', 'CₙH₂ₙ₊₂ (Saturated Hydrocarbons)'],
            ['Alkene General Formula', 'CₙH₂ₙ (Unsaturated Hydrocarbons with double bond)'],
            ['Alkyne General Formula', 'CₙH₂ₙ₋₂ (Unsaturated Hydrocarbons with triple bond)'],
            ...
            ['Saturated Hydrocarbon', 'Hydrocarbons containing only single covalent bonds between carbon atoms'],
            ['Unsaturated Hydrocarbon', 'Hydrocarbons containing double or triple covalent bonds between carbon atoms'],
            ['', ''],
            ['Periodic Classification', ''],
            ['Periodic Table', 'The arrangement of chemical elements organized by atomic number and chemical properties'],
            ['Group definition', 'A vertical column of elements in the periodic table'],
            ['Period definition', 'A horizontal row of elements in the periodic table'],
            ['Valency definition', 'The combining capacity of an element based on its valence electrons'],
            ['', ''],
            ['Life Processes (Chemistry Link)', ''],
            ['Photosynthesis Reaction', '6CO₂ + 6H₂O → C₆H₁₂O₆ (Glucose) + 6O₂ (in presence of sunlight & chlorophyll)'],
            ['Respiration definition', 'Process of releasing energy from food (glucose breakdown)'],
            ['Photosynthesis definition', 'Process by which green plants manufacture food from carbon dioxide and water using sunlight'],
            ['', ''],
            ['Important Chemical Calculations', ''],
            ['Number of moles (n)', 'n = m / M (Given mass / Molar mass)'],
            ['Number of particles (N)', 'N = n × 6.022 × 10²³ (Avogadro Number)'],
            ['Concentration (Molarity)', 'M = n / V (n = moles, V = volume in Liters)'],
            ['Example Molarity', 'n = 1.2 mol, V = 0.8 L → M = 1.2 / 0.8 = 1.5 mol/L'],
            ['Mole definition', 'Amount of substance containing exactly 6.022 × 10²³ elementary entities'],
            ['Molar Mass definition', 'Mass of one mole of a substance'],
            ['Avogadro Number', '6.022 × 10²³ (The number of entities in one mole)'],
            ['', ''],
            ['Gases (Basic)', ''],
            ['Ideal Gas Equation', 'PV = nRT (P = pressure, V = volume, n = moles, R = gas constant, T = temperature)'],
            ['Pressure definition', 'Force acting per unit area'],
            ['Volume definition', 'The space occupied by the gaseous substance'],
            ['Temperature definition', 'The absolute temperature measured in Kelvin (K)'],
            ['', ''],
            ...
            ['Ideal Gas Equation', 'PV = nRT'],
            ['Alkane Formula', 'Alkane = CₙH₂ₙ₊₂'],
            ['Alkene Formula', 'Alkene = CₙH₂ₙ'],
            ['Alkyne Formula', 'Alkyne = CₙH₂ₙ₋₂']
        ]
    }
};
